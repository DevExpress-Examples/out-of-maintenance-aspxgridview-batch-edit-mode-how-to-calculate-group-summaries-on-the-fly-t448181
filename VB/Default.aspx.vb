...
Partial Public Class _Default
    ...
    Protected ReadOnly Property GridData() As List(Of GridDataItem)
        Get
            ...
            If (Not IsPostBack) OrElse Session(key) Is Nothing Then
                Session(key) = Enumerable.Range(0, 20).Select(Function(i) New GridDataItem With {.ID = i, .C1 = i Mod 5, .C2 = i * 0.5 Mod 9, .C3 = "C3_" & i Mod 5, .C4 = i Mod 2 = 0, .C5 = New Date(2013 + i, 12, 16)}).ToList()
            End If
    ...
    Protected Function GetTotalGroupSummaryValue(ByVal index As Integer) As Object
        Dim summaryItem As ASPxSummaryItem = Grid.GroupSummary.First(Function(i) i.Tag = "C2_SumGroup")
